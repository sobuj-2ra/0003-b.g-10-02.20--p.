						...
						@if (!empty($printer))
							<div class="toggle">
								@foreach ($printer as $single_printer)
									<input type="radio" name="printer" value="{{ $single_printer->device_ip }}" id="{{ $single_printer->device_id }}" required />
...
{{-- 				<div class="col-12">
				...
				<div class="col-12">
					...
					<button class="btn btn-primary mt-2" id="printBrcode">Mobile Print</button>
					<!-- <button class="btn btn-info mt-2 " type="submit">PC Print</button>  -->
					<?php echo $printlink; ?>
