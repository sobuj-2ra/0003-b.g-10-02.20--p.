...
<!-- Content Header (Page header) -->
    ...
    <section class="content">
      ...
      <div class="box box-success">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" id="ajax_form" action="{{ route('devices.store') }}" method="POST" enctype="multipart/form-data">
          <div class="box-body">
            {{ csrf_field() }}

            <div class="form-group">
              <label for="device_name">Device Name</label>
              <input type="text" name="device_name" class="form-control" id="device_name" placeholder="Enter device Name" value="{{ old('device_name') }}" required="">
            </div>

            <div class="form-group">
              <label for="device_id">Device Code/ID</label>
              <input type="text" name="device_id" class="form-control" id="device_id" placeholder="Enter device Name" value="{{ old('device_id') }}" required="">
              <span id="deviceError" class="bg-danger"></span>
            </div>

            <div class="form-group">
              <label for="device_ip">Device Ip/Number</label>
              <input type="text" name="device_ip" class="form-control" id="device_ip" placeholder="Enter device Name" value="{{ old('device_ip') }}">
            </div>
