...
<div class="login-box">
  <div class="login-logo">
    <a href="{{ route('index') }}"><b>Admin</b>Reset Password</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="{{ route('admin.password.request') }}" method="post">
      ...
      <div class="form-group has-feedback">
        <input id="password-confirm" type="password" name="password_confirmation" required class="form-control" placeholder="Password again" required>
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
